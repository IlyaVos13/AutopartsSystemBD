...
namespace AutopartsSystemBD
{
    public static class DataStore
    {
        private static readonly string ConnectionString =
            "Host=localhost;Port=5432;Database=autoparts_db;Username=postgres;Password=your_passw";
        ...
        public static void AddPurchase(int suppliedPartId, DateTime purchaseDate, int quantity)
        {
            ...
            using var connection = GetConnection();
            using var command = new NpgsqlCommand(
                "INSERT INTO purchases (supplied_part_id, purchase_date, quantity, unit_price, total_sum) VALUES (@supplied_part_id, @purchase_date, @quantity, @unit_price, @total_sum)",
                connection
            );
        ...
        private static void LoadPurchases()
        {
            ...
            using var connection = GetConnection();
            using var command = new NpgsqlCommand("SELECT id, supplied_part_id, purchase_date, quantity, unit_price, total_sum FROM purchases ORDER BY id", connection);
            using var reader = command.ExecuteReader();
